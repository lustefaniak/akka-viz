...
import akkaviz.frontend.FancyColors
import akkaviz.frontend.vis.{DataSet, Graph2d, Group, Item, Properties}
...
class ThroughputGraphViewTab(implicit ctx: Ctx.Owner) extends Tab with FancyColors {
