...
package object types {
  ...
  case class ThroughputMeasurement(actorRef: ActorRef, msgsPerSecond: Double, timestamp: Long = System.currentTimeMillis()) extends InternalEvent with BackendEvent
